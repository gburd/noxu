...
**Current version**: 7.10.1.  See [CHANGELOG.md](CHANGELOG.md) for the full
release history.
...
```toml
[dependencies]
noxu = "7"  # or pin to a specific version, e.g. "7.10.1"
```
...
[v7.10.1 capability matrix](https://codeberg.page/gregburd/noxu/introduction.html#capability-matrix).
