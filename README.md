...
**Current version**: 7.7.0.  See [CHANGELOG.md](CHANGELOG.md) for the full
release history.
...
```toml
[dependencies]
noxu = "7"  # or pin to a specific version, e.g. "7.7.0"
```
...
```toml
[dependencies]
noxu = { git = "https://codeberg.org/gregburd/noxu.git", tag = "v7.7.0" }
```
...
[v7.7.0 capability matrix](https://codeberg.page/gregburd/noxu/introduction.html#capability-matrix).
