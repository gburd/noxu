...
//!
//! Sits behind the public `crate::db::DiskOrderedCursor` API.  Spawns a
...
use crate::recovery::{LnOperation, LogEntry, LogScanner, PositionedEntry};

use crate::dbi::database_id::DatabaseId;
use crate::dbi::error::{DbiError, Result};
...
fn produce(
    ...
    for &file_num in &file_nums {
        ...
        let start = crate::util::Lsn::new(file_num, 0);
        let end = crate::util::Lsn::new(file_num.saturating_add(1), 0);
