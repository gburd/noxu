...
use crate::tree::{KeyComparatorFn, Tree};
...
impl DatabaseTree {
    pub fn new() -> Self {
        DatabaseTree { root_lsn: crate::util::NULL_LSN.as_u64() }
    }
...
impl DatabaseImpl {
    ...
    /// metadata databases).
    pub fn collect_btree_stats(&self) -> Option<crate::tree::TreeStats> {
        self.real_tree
            .as_ref()
            .and_then(|arc| arc.read().ok())
    ...
    pub fn write_to_log(&self, buf: &mut Vec<u8>) -> std::io::Result<()> {
        ...
        let root_lsn = self
            .tree
            .as_ref()
            .map_or(crate::util::NULL_LSN.as_u64(), |t| t.root_lsn);
...
mod tests {
    ...
    fn test_tree_access() {
        ...
        // Default tree has NULL_LSN
        {
            ...
            assert_eq!(tree.get_root_lsn(), crate::util::NULL_LSN.as_u64());
        }
