...
///
/// Mirrors `crate::db::durability::ReplicaAckPolicy` and
/// `crate::rep::commit_durability::ReplicaAckPolicy` without taking
...
/// policy on commit.
///
/// Implementations are typically `crate::rep::ReplicatedEnvironment`. The
...
pub trait ReplicaAckCoordinator: Send + Sync {
    ...
    fn alloc_vlsn_for_recovered_commit(&self, _lsn: crate::util::Lsn) -> u64 {
        0
    }
}
