...
pub enum NoxuLogError {
    ...
    Checksum { lsn: crate::util::lsn::Lsn, message: String },
    ...
    InvalidEntryType { type_num: u8, lsn: crate::util::lsn::Lsn },

    /// Invalid entry size.
    #[error("Invalid entry size {size} at LSN {lsn}")]
    InvalidEntrySize { size: i32, lsn: crate::util::lsn::Lsn },

    /// Unexpected end of data.
    #[error("Unexpected EOF at LSN {lsn}: {message}")]
    UnexpectedEof { lsn: crate::util::lsn::Lsn, message: String },
