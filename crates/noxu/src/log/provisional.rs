...
mod tests {
    ...
    fn test_no_never_provisional() {
        ...
        assert!(
            !Provisional::No.is_provisional(entry_lsn, crate::util::NULL_LSN)
        );
    }
    ...
    fn test_yes_always_provisional() {
        ...
        assert!(
            Provisional::Yes.is_provisional(entry_lsn, crate::util::NULL_LSN)
        );
    }
    ...
    fn test_before_ckpt_end() {
        ...
        assert!(
            !Provisional::BeforeCkptEnd
                .is_provisional(before_lsn, crate::util::NULL_LSN)
        );
    }
}
