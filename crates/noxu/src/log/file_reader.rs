...
use crate::log::entry_header::CHECKSUM_BYTES;
...
impl LogEntryHeader {
    ...
    pub fn from_bytes(buf: &[u8]) -> Result<Self> {
        ...
        if item_size > crate::log::MAX_ITEM_SIZE {
...
mod tests {
    ...
    fn test_from_bytes_rejects_oversized_item_size() {
        ...
        let oversize: u32 = (crate::log::MAX_ITEM_SIZE as u32) + 1;
        ...
        assert!(
            matches!(
                result,
                Err(crate::log::error::NoxuLogError::InvalidEntrySize { .. })
            ),
