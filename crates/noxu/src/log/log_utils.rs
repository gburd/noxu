...
mod tests {
    ...
    fn test_packed_i32_size_tiers() {
        ...
        // crate::util::packed uses the same encoding as the:
        //   1 byte : -119..=119
        //   2 bytes: +/-120..
        //   3 bytes: ...
        //   4 bytes: ...
