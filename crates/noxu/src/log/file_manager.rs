...
use crate::log::error::{LogError, Result};
use crate::log::file_handle::FileHandle;
use crate::log::file_header::{FILE_HEADER_SIZE, FileHeader, LOG_VERSION};
...
pub struct FileManager {
    ...
    /// LRU cache of open file handles.
    ///
    /// Protected by `crate::sync::Mutex` because `lru::LruCache::get()` mutates
...
impl FileManager {
    ...
    pub fn new(
        ...
        let manager = FileManager {
            ...
            last_used_lsn: AtomicU64::new(crate::util::lsn::NULL_LSN.as_u64()),
