...
///   surrounding [`crate::db::transaction_config::TransactionConfig`] (it
///   is honoured by [`crate::db::cursor::Cursor`] via the txn's locker)
///   or pass [`crate::db::lock_mode::LockMode::ReadCommitted`] to a
///   per-operation [`crate::db::read_options::ReadOptions`].
...
/// * `evict_ln` — use [`crate::db::cache_mode::CacheMode::Unchanged`] /
...
pub struct CursorConfig {
    ...
    /// [`crate::db::read_options::ReadOptions`]) take precedence at the
    /// individual `get` call.
