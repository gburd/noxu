...
//!
//! ```no_run
//! use crate::db::{EnvironmentConfig, DatabaseConfig};
...
/// Users can access `crate::db::observe_crate::{metrics, tracing}` for their own
/// recorder/subscriber setup.
#[cfg(feature = "observability")]
pub use crate::observe as observe_crate;
