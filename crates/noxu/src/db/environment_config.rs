...
use crate::db::error::ExceptionListener;
use std::fmt;
...
pub struct EnvironmentConfig {
    ...
    /// [`crate::db::transaction_config::TransactionConfig::set_serializable_isolation`]
    /// and [`crate::db::transaction_config::TransactionConfig::set_read_committed`].
