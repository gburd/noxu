//! Lazy iterator adapters for [`crate::db::Database`].
//!
//! Provides [`DbIter`] (full-scan, forward) and [`DbRange`] (key-range scan)
//! as convenience wrappers around the underlying [`crate::db::Cursor`] API.
//!
//! # Design
//!
...
//!
//! ```no_run
//! use crate::db::{DatabaseConfig, DatabaseEntry, Environment, EnvironmentConfig};
...
///
/// Returned by [`crate::db::Database::iter`].  Holds a live [`crate::db::Cursor`]; records are
...
///
/// Returned by [`crate::db::Database::range`].  Holds a live [`crate::db::Cursor`] positioned at
