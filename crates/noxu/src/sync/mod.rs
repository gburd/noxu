...
//!
//! ```text
//! parking_lot::Mutex<T>          →  crate::sync::Mutex<T>
//! parking_lot::RwLock<T>         →  crate::sync::RwLock<T>
//! parking_lot::Condvar           →  crate::sync::Condvar
//! parking_lot::RawMutex          →  crate::sync::RawMutex
//! parking_lot::lock_api::…       →  crate::sync::lock_api::…
//! parking_lot::MutexGuard<'_,T>  →  crate::sync::MutexGuard<'_,T>
//! parking_lot::WaitTimeoutResult →  crate::sync::WaitTimeoutResult
//! ```
...
/// Re-export `lock_api` so callers can do `use crate::sync::lock_api::RawMutex`.
pub use lock_api;
