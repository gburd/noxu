...
//! service are passed to [`crate::rep::elections::paxos::run_acceptor`]
...
use crate::rep::elections::acceptor_state::PersistentAcceptorState;
use crate::rep::elections::paxos::run_acceptor_with_state;
...
mod tests {
    use super::*;
    use crate::rep::elections::paxos::run_election;
    use crate::rep::net::channel::TcpChannel;
    use crate::rep::net::service_dispatcher::{
