...
use crate::rep::elections::phi_detector::PhiAccrualDetector;
use crate::rep::elections::proposal::Proposal;
use crate::rep::error::{RepError, Result};
use crate::rep::net::channel::Channel;
use crate::rep::protocol::ProtocolMessage;
...
pub fn run_acceptor_with_state(
    ...
    own_priority: u32,
    own_term: u64,
    state: &crate::rep::elections::acceptor_state::PersistentAcceptorState,
) -> Result<Option<String>> {
    let timeout = Duration::from_millis(500);
