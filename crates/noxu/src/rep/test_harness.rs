...
//!   group with an in-memory [`crate::rep::net::LocalChannel`] transport,
...
//! [`crate::rep::net::TcpChannel`] / [`crate::rep::net::TcpChannelListener`]
...
//! # fn demo() {
//! use crate::rep::test_harness::RepTestBase;
//!
...
use crate::rep::replicated_environment::ReplicatedEnvironment;
...
impl RepTestBase {
    ...
    pub fn create_group_of_size(
        ...
        let peer_specs: Vec<crate::rep::rep_node::RepNode> = self.nodes[..first_n]
            .iter()
            .map(|n| {
                crate::rep::rep_node::RepNode::new(
