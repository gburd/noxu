...
use crate::rep::net::service_dispatcher::{ServiceHandler, connect_to_service};
...
pub struct AdminService {
    env: Weak<crate::rep::replicated_environment::ReplicatedEnvironment>,
}
...
pub fn register_admin_service(
    dispatcher: &crate::rep::net::service_dispatcher::TcpServiceDispatcher,
    env: Weak<crate::rep::replicated_environment::ReplicatedEnvironment>,
) {
