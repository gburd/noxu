    ...
    E: Entity<PrimaryKey = PK> + Clone + Send + Sync + 'static,
{
    ...
    pub fn get<S: EntitySerializer<E>>(
        ...
        serializer: &S,
        primary: &crate::persist::primary_index::PrimaryIndex<'_, PK, E>,
        sk: &SK,
    ) -> Result<Option<E>> {
    ...
    pub fn iter<'a, S: EntitySerializer<E>>(
        ...
        serializer: &'a S,
        primary: &'a crate::persist::primary_index::PrimaryIndex<'_, PK, E>,
    ...
    E: Entity<PrimaryKey = PK> + Clone + Send + Sync + 'static,
{
    ...
    txn: Option<&'a Transaction>,
    serializer: &'a S,
    primary: &'a crate::persist::primary_index::PrimaryIndex<'a, PK, E>,
...
mod tests {
    ...
    fn setup() -> (TempDir, Environment, crate::db::Database) {
        let td = TempDir::new().unwrap();
