...
///
/// ```
/// use crate::persist::{Entity, PrimaryKey};
///
/// struct User {
///     id: u64,
///     name: String,
...
pub trait Entity: Sized {
    ...
    /// [`crate::persist::evolve::Mutations`] via
    /// [`crate::persist::store_config::StoreConfig::with_mutations`] so that older
