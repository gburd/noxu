...
use crate::db::{Database, DatabaseEntry, OperationStatus, Transaction};
...
use crate::persist::secondary_index::{
    ...
    E: Entity<PrimaryKey = K> + Clone + Send + Sync + 'static,
{
    ...
    ///
    /// ```no_run
    /// # use crate::persist::{Entity, PrimaryKey, PrimaryIndex, EntitySerializer, Result};
    /// # use crate::persist::secondary_index::SecondaryIndex;
    /// # use crate::db::{Database, DatabaseConfig, Environment, EnvironmentConfig};
    ...
    /// `crate::db::Database::{get,put,delete}` shape.
    ///
    /// # Errors
    ...
    /// **unless** a [`crate::persist::evolve::Renamer::for_class`] mutation
...
mod tests {
    ...
    use crate::persist::entity_serializer::EntitySerializer;
    use crate::db::{DatabaseConfig, Environment, EnvironmentConfig};
    use tempfile::TempDir;
