...
pub struct StoreConfig {
    ...
    /// transaction; class-level [`crate::persist::evolve::Renamer`] /
    /// [`crate::persist::evolve::Deleter`] / [`crate::persist::evolve::Converter`] are
...
impl StoreConfig {
    ...
    ///
    /// [`EntitySerializer::deserialize_versioned`]: crate::persist::entity_serializer::EntitySerializer::deserialize_versioned
...
mod tests {
    ...
    fn test_with_mutations_round_trip() {
        use crate::persist::evolve::{Mutations, Renamer};
