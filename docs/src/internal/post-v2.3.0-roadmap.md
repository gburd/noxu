...
| 11-S | v2.5.0 | UX + docs + cleanup from 2026-05 audit (H-1, H-3, H-5–H-8, Q-1, Q-2, Q-6, Q-7) | **dispatched** — Cursor/Database Iterator, abort lock-hold, log-alloc reduction, on-disk-format doc accuracy, slow-test gating |
